  ...
  return (
    <>
      ...
      <div style={{ marginTop: "24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
          {[
            { src: VAULT + "Renderings/01-aerial-perspective.jpg", title: "Rendering 1", sub: "Aerial Perspective — full site development concept" },
            { src: VAULT + "Renderings/02-streetscape.jpg", title: "Rendering 2", sub: "Streetscape — internal road with mixed-use buildings" },
            { src: VAULT + "Renderings/03-bissonnet-entrance.jpg", title: "Rendering 3", sub: "Bissonnet Entrance — monument and first buildings" },
            { src: VAULT + "Renderings/04-soccer-park-clubhouse.jpg", title: "Rendering 4", sub: "Soccer Park & Clubhouse — 5-acre community amenity" },
          ].map((r, i) => (
