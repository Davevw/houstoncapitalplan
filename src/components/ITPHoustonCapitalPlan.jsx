        ...
        <div style={{maxWidth:1200,margin:"0 auto"}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexWrap:"wrap",gap:16}}>
            <div style={{display:"flex",alignItems:"center",gap:16}}>
              ...
              <div>
                <div style={{fontSize:22,fontWeight:800,letterSpacing:2.4,color:GOLD,textTransform:"uppercase",marginBottom:4}}>LANDCO NEXA</div>
    ...
    return(<div style={{display:"flex",justifyContent:"center",alignItems:"center",minHeight:400}}>
      <div style={{background:"white",borderRadius:16,padding:40,boxShadow:"0 4px 24px rgba(0,0,0,0.12)",textAlign:"center",maxWidth:380,width:"100%"}}>
        ...
        <input
          ...
          onKeyDown={e=>{if(e.key==="Enter"){if(code.toUpperCase()==="ML01"){setUnlocked(true);}else{setError(true);setCode("");}}}}
        ...
        <button onClick={()=>{if(code.toUpperCase()==="ML01"){setUnlocked(true);}else{setError(true);setCode("");}}} style={{width:"100%",padding:"12px",borderRadius:8,background:NAVY,color:"white",fontSize:14,fontWeight:600,border:"none",cursor:"pointer"}}>Unlock</button>
      </div>
    </div>);
  }
  ...
  if(!unlocked){
    return(<div style={{display:"flex",justifyContent:"center",alignItems:"center",minHeight:400}}>
      <div style={{background:"white",borderRadius:16,padding:40,boxShadow:"0 4px 24px rgba(0,0,0,0.12)",textAlign:"center",maxWidth:380,width:"100%"}}>
        ...
        <input type="password" value={code} onChange={e=>{setCode(e.target.value);setError(false);}} onKeyDown={e=>{if(e.key==="Enter"){if(code.toUpperCase()==="ML01"){setUnlocked(true);}else{setError(true);setCode("");}}}} placeholder="Access Code" style={{width:"100%",padding:"12px 16px",borderRadius:8,border:`2px solid ${error?"#E85D75":"#D0D7DE"}`,fontSize:14,textAlign:"center",letterSpacing:4,marginBottom:12,outline:"none",boxSizing:"border-box"}}/>
        {error&&<div style={{fontSize:12,color:"#E85D75",marginBottom:12}}>Invalid code. Please try again.</div>}
        <button onClick={()=>{if(code.toUpperCase()==="ML01"){setUnlocked(true);}else{setError(true);setCode("");}}} style={{width:"100%",padding:"12px",borderRadius:8,background:NAVY,color:"white",fontSize:14,fontWeight:600,border:"none",cursor:"pointer"}}>Unlock</button>
      </div>
    </div>);
